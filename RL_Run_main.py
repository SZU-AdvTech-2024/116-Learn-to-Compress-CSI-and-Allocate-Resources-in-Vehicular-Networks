# implement the Testing main function for the C-Decision scheme with the Real feedback
...
def run_test(curr_RL_Config, BS_Agent, test_seed_sequence):
    ...
    if Opt_Flag:
        ...
        print('To Run Test C-Decision with Optimal Scheme!')
...
def robust_run_test(curr_RL_Config, BS_Agent, test_seed_sequence):
    # run the Robust test according to current settings via the trained model
    """
    Run the Robust Test
    """
    save_flag = False      # check the saving process
